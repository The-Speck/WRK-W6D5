...
var Clock = function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    key: "fullDate",
    value: function fullDate() {
      var monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
      var dateName = 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday'.split(',');
      var month = monthNames[this.state.time.getMonth()];
      var day = dateName[this.state.time.getDay()];
      var dateNum = this.state.time.getDate();
      var year = this.state.time.getFullYear();

      var stringDate = day + " " + month + " " + dateNum + ", " + year;
      return stringDate;
    }
  }, {
    key: "fullTime",
    value: function fullTime() {
      var zone = this.state.time.toLocaleTimeString('en-us', { timeZoneName: 'short' }).split(' ')[2];
      var hour = this.state.time.getHours() % 12;
      var min = this.state.time.getMinutes();
      var sec = this.state.time.getSeconds();

      var stringTime = hour + " : " + min + " : " + sec + " " + zone;
      return stringTime;
    }
  }, {
    key: "render",
...
var Root = function Root() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_tab2.default, { arr: [{ title: 'one', content: 'I am the first' }, { title: 'two', content: 'Second pane here' }, { title: 'three', content: 'Third pane here' }] })
    ),
    _react2.default.createElement(
      'div',
      null,
...
var Tab = function (_React$Component) {
  ...
  _createClass(Tab, [{
    key: 'bringFront',
    value: function bringFront(key, event) {
      this.setState({ selectedTab: key });
    }
  }, {
    key: 'isFront',
    value: function isFront(idx) {
    ...
    key: 'generateTabs',
    value: function generateTabs() {
      var _this2 = this;

      return this.props.arr.map(function (tab, idx) {
        return _react2.default.createElement(
          'div',
          { className: _this2.isFront(idx) },
          _react2.default.createElement(
            'section',
            { onClick: _this2.bringFront.bind(_this2, idx), key: idx, className: 'tab-header' },
            tab.title
          ),
          _react2.default.createElement(
            'section',
...
var fetchWeather = function fetchWeather(options) {
  return $.ajax(options);
};
...
var _util = __webpack_require__(/*! ./util */ "./frontend/util.js");
...
var Weather = function (_React$Component) {
  ...
  _createClass(Weather, [{
    key: 'getWeather',
    value: function getWeather(data) {
      var lat = data.coords.latitude;
      var lon = data.coords.longitude;
      var url = 'http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + lon + '&appid=c1e452b6676255adf9e0bd477e07b8fb';
      var options = { method: 'GET', url: url };
      (0, _util2.default)(options).then(this.parseWeather.bind(this));
    }
  }, {
    key: 'parseWeather',
